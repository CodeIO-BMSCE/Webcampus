...
export default function Page() {
  ...
  return (
    <div className="p-8 text-sm">
      ...
      <div className="mb-4 flex items-center gap-4 text-sm font-semibold text-blue-600">
        ...
        <table className="min-w-full border-collapse border text-left text-sm">
          <thead className="bg-light text-sm uppercase">
            <tr className="bg-gray-500">
              ...
              <th className="border px-3 py-2">FACULTY NAME</th>
              <th className="border px-3 py-2">TOTAL</th>
              <th className="border px-3 py-2">NA</th>
              <th className="border px-3 py-2">PRESENT</th>
              <th className="border px-3 py-2">ABSENT</th>
              <th className="border px-3 py-2">CONDONATION</th>
              <th className="border px-3 py-2">% PER.</th>
            </tr>
          </thead>
          <tbody>
            {attendanceData.map((row, i) => (
              <tr key={i} className="hover:bg-black-50">
