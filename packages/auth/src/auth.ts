...
<body>
  <div class='container'>
    ...
    <div class='content'>
      Hello,<br /><br />
      We received a request to reset your password for your BMSCE Webcampus account.<br /><br />
      If you initiated this request, please click the button below to set a new password:
    </div>
    <div class='button-container'>
      <a href='http://localhost:3000/auth/reset-password?token=YOUR_TOKEN_HERE' class='button' target='_blank'>
        Reset Password
      </a>
    </div>
    <div class='content'>
